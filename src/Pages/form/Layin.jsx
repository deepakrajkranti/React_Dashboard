    ...
    <div className="FormBase1">
      <form onSubmit={onSubmitHandler}>
        ...
        <div className="container">
          ...
          />
          {/* <h4>Choose a week:</h4>
         <select name="week" value={inputFields.week} onChange={handleChange}>
        ...
        <div className="container">
          <h4> Effort Hours.</h4>
          <select name="hour" value={inputFields.hour} onChange={handleChange}>
